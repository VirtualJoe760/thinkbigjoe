  ...
  return (
    <div className="px-6 py-8">
      <div className="mx-auto w-full max-w-4xl">
        ...
        {portalError ? (
          <div className="rounded-2xl border border-line bg-background p-6 text-sm text-ink-soft">
          ...
          <div className="space-y-2">
            {portal.map((u, i) => (
              <div key={i} className="flex items-center justify-between rounded-xl border border-line bg-background px-4 py-3">
                <div>

...
// (Mon–Fri 10am–5pm Pacific, lunch break at noon) straight from the dashboard. Unlike the public
...
export async function getPortalSlots(
  ...
  try {
    const slots = await getAvailableSlots(date); // default = regular 10–5 PT window (lunch break at noon)
...
/**
 * Request a call OUTSIDE Joe's regular 10–5 PT window. Unlike bookStrategyCall this does NOT

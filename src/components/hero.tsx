    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 pt-24 pb-20 md:pt-32 md:pb-28">
        ...
        <h1 className="mt-8 max-w-4xl text-5xl font-extrabold leading-[1.05] tracking-tight text-balance md:text-7xl">
          Don&apos;t just adopt AI.
          <br />
          Deploy <span className="text-brand">agents</span> that run your
          business.
        </h1>

        <p className="mt-6 max-w-2xl text-lg leading-relaxed text-ink-soft md:text-xl">
          ThinkBigJoe designs and ships agentic software and Model Context
          Protocol systems that automate the work, capture the leads, and scale
          what your team does best — built custom, built to last.
        </p>
        ...
        <dl className="mt-16 grid max-w-2xl grid-cols-3 gap-8 border-t border-line pt-8">
          {[
            { k: "Agentic", v: "AI that takes action, not just answers" },
            { k: "MCP-native", v: "Tools your models actually plug into" },
            { k: "End-to-end", v: "Strategy, build, and ship" },
          ].map((s) => (
            <div key={s.k}>

...
> **Status**: SPEC, ready to build · **Written**: 2026-07-19
...
**Stage 2 — the shared agent** *(blocked on the doc verification above)*
...
**Stage 4 — booking** *(only after tiers 1 is selling)*
